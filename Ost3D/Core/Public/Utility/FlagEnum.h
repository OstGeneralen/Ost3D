...
// FlagEnum
// ------------------------------------------------------------
// Utilities to make enum class easily usable as flags
// Use:
// enum class MyEnum
// {
//		A = 1 << 0,
...
// IS_FLAGS(MyEnum);
// 
// You can now use this enum like MyEnum::A | MyEnum::B
// 
// For checking flags you can use the a & b operator OR
// make a Flags<EnumType> object which has utility functions
